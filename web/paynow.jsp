...
if (request.getParameter("book")!=null)
   ...
   // out.println(uid);
        int i=0;
      i= st1.executeUpdate("update  book  set sta='paid' where bid='"+ a1 +"'");
     if (i==1)
   {
...
<form action="" name="register_form"  id="register_form"  method="post" >
	...
	<tr>
		...
		<td><input type="text" name="tamt" value="<%= resultset.getString(10) %>" readonly/></td>
	</tr>
        
        <tr>
		<td class="col">Card Number:</td>
		<td><input type="text" name="tamt" value="" required/></td>
	</tr>
        <td></td>
